...
import AdminResumeRequests from './AdminResumeRequests';
import {
  LogOut,
  Mail,
  RefreshCw,
...
const AdminMessages = () => {
  ...
  const [activeTab, setActiveTab] = useState('messages'); // 'messages' | 'resume'
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[#00ff9d]/10 border border-[#00ff9d]/30 flex items-center justify-center text-[#00ff9d]">
              {activeTab === 'messages' ? <Mail className="w-4 h-4" /> : <FileText className="w-4 h-4" />}
            </div>
            <div>
              ...
              <h1 className="text-base sm:text-lg font-black text-slate-100 flex items-center gap-2">
                <span>{activeTab === 'messages' ? 'Contact Messages' : 'Resume Requests'}</span>
                {activeTab === 'messages' && (
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'messages'
                ...
                : 'bg-[#040c0e] text-slate-400 border border-slate-800 hover:text-slate-200'
            }`}
          >
