    ...
    list: [
      {
        ...
        color: 'amber',
        icon: 'cloud',
        skills: ['AWS Infrastructure', 'Cloud Concepts', 'Security & Compliance', 'Cloud Architecture'],
        image: '/images/aws_cloud_practitioner_essentials.png',
        verifyUrl: 'https://aws.amazon.com/training/',
        description: 'Awarded by AWS Training & Certification for demonstrating comprehensive foundational knowledge of AWS Cloud concepts, infrastructure services, security, architecture, and cloud operations.',
      },
      {
        ...
        color: 'rose',
        icon: 'code',
        skills: ['Python Programming', 'Algorithms', 'Data Processing', 'Problem Solving', 'Score: 95%'],
        image: '/images/nptel_python.png',
        verifyUrl: 'https://nptel.ac.in/noc/',
        description: 'Secured Elite certification with a Top 5% Topper distinction and a consolidated score of 95% (Assignments: 24.44/25, Proctored Exam: 70.5/75) out of 21,919 certified candidates in the 12-week national course organized by IIT Madras.',
      },
      {
        id: 'postman-api-student-expert',
        fileName: 'postman-api-fundamentals.crt',
        title: 'Postman API Fundamentals Student Expert',
        issuer: 'Postman',
        issueDate: '2025',
        credentialId: 'POSTMAN-API-EXP-771',
        badge: 'API EXPERT',
        category: 'API & INTEGRATION',
        color: 'sky',
        icon: 'terminal',
        skills: ['REST APIs', 'API Testing', 'Postman Collections', 'Authentication', 'Automation'],
        image: null,
        verifyUrl: 'https://badgr.com/public/assertions',
        description: 'Verified technical expertise in designing, consuming, testing, documenting, and automating RESTful APIs using Postman developer tools.',
      },
      {
        id: 'hackerrank-problem-solving',
        fileName: 'hackerrank-problem-solving-advanced.crt',
        title: 'HackerRank Problem Solving & Node.js',
        issuer: 'HackerRank',
        issueDate: '2024',
        credentialId: 'HK-PS-ADV-4029',
        badge: 'VERIFIED SKILLS',
        category: 'ALGORITHMS & NODE.JS',
        color: 'emerald',
        icon: 'code',
        skills: ['Data Structures', 'Algorithms', 'Node.js', 'Asynchronous JS', 'Performance'],
        image: null,
        verifyUrl: 'https://www.hackerrank.com/certificates',
        description: 'Verified proficiency in algorithmic problem solving, complex data structures, and asynchronous Node.js backend execution runtime.',
      },
    ],
  },
