export const portfolioData = {
  ...
  certifications: {
    headingCommand: 'ls -la /certifications/',

    list: [
      {
        id: 'oracle-cloud-foundations-associate',
        fileName: 'oracle-cloud-infrastructure-foundations.crt',
        title: 'Oracle Cloud Infrastructure 2025 Certified Foundations Associate',
        issuer: 'Oracle University',
        issueDate: 'Oct 30, 2025',
        credentialId: '103056584OCI25FNDCFA',
        badge: 'ORACLE CERTIFIED ASSOCIATE',
        color: 'amber',
        icon: 'cloud',
        image: '/images/oracle_cloud_foundations_associate.png',
        description: 'Recognized by Oracle Corporation as Oracle Certified Foundations Associate for Oracle Cloud Infrastructure.',
      },
      {
        id: 'aws-cloud-practitioner-essentials',
        fileName: 'aws-cloud-practitioner-essentials.crt',
        title: 'AWS Cloud Practitioner Essentials',
        issuer: 'AWS Training & Certification',
        issueDate: 'July 20, 2026',
        credentialId: 'AWS-TRAINING-CERT',
        badge: 'AWS OFFICIAL CERTIFICATE',
        color: 'sky',
        icon: 'cloud',
        image: '/images/aws_cloud_practitioner_essentials.png',
        description: 'Awarded by AWS Training & Certification for demonstrating foundational knowledge of AWS Cloud concepts, services, and cloud operations.',
      },
      {
        id: 'nptel-joy-of-python',
        fileName: 'nptel-joy-of-computing-python.crt',
        title: 'The Joy of Computing using Python',
        issuer: 'NPTEL (IIT Madras / MoE Govt. of India)',
        issueDate: 'Jan-Apr 2026',
        credentialId: 'NPTEL26CS84S454501242',
        badge: 'ELITE + TOPPER (TOP 5%)',
        color: 'rose',
        icon: 'code',
        image: '/images/nptel_python.png',
        description: 'Secured Elite certification with a Top 5% Topper distinction and a consolidated score of 95% out of 21,919 certified candidates.',
      },
      {
        id: 'cisco-linux-unhatched',
        fileName: 'cisco-linux-unhatched.crt',
        title: 'Linux Unhatched',
        issuer: 'Cisco Networking Academy | NDG',
        issueDate: '21 Feb 2026',
        credentialId: 'CISCO-NDG-LINUX',
        badge: 'CISCO NETWORKING ACADEMY',
        color: 'emerald',
        icon: 'terminal',
        image: '/images/cisco_linux_unhatched.png',
        description: 'Offered by Bannari Amman Institute of Technology through the Cisco Networking Academy program for successfully completing Linux Unhatched.',
      },
      {
        id: 'cisco-os-basics',
        fileName: 'cisco-operating-systems-basics.crt',
        ...
        color: 'violet',
        icon: 'layers',
        image: '/images/cisco_os_basics.png',
        description: 'Offered by Bannari Amman Institute of Technology through the Cisco Networking Academy program for successfully completing Operating Systems Basics.',
      },
      {
        id: 'cisco-js-essentials-1',
        fileName: 'cisco-javascript-essentials-1.crt',
        title: 'JavaScript Essentials 1',
        issuer: 'Cisco Networking Academy | JS Institute',
        issueDate: '21 Feb 2026',
        credentialId: 'CISCO-JS-ESS-1',
        badge: 'JS INSTITUTE CERTIFIED',
        color: 'amber',
        icon: 'code',
        image: '/images/cisco_javascript_essentials_1.png',
        description: 'Offered by Bannari Amman Institute of Technology through the Cisco Networking Academy program for successfully completing JavaScript Essentials 1.',
      },
    ],
  },
